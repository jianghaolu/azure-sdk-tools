...
namespace Microsoft.WindowsAzure.Commands.Common.Properties {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Azure Resource Manager is not supported in your environment. To use Azure Resource Manager, please switch to other environments using the Set-AzureEnvironment cmdlet..
        /// </summary>
        public static string EnvironmentDoesNotSupportARM {
            get {
                return ResourceManager.GetString("EnvironmentDoesNotSupportARM", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to This account was not authorized for any Azure subscriptions. Please log in with an account that is authorized for use with one or more Azure subscriptions..
        /// </summary>
